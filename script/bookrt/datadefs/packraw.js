...
export class PackageRaw {
    ...
    constructor(fileinfo, internals, sourceType, servbook, serviceUrl) {
        try {
    ...
    get annotation() {
        return (this._servbook) ? this._servbook.description : "";
    }
    makeUniqueName() {
